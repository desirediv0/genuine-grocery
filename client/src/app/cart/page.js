                    ...
                    <div className="flex flex-col items-end md:items-center">
                        ...
                        {!isLoading && !item.isAuthenticated && item.hidePricesForGuests ? (
                            ...
                            <>
                                ...
                                <span className={`font-semibold ${item.priceSource === 'FLASH_SALE' ? 'text-primary' : 'text-gray-900'}`}>
                                    {formatCurrency(item.price)}
                                </span>
                                {item.priceSource === 'FLASH_SALE' && item.flashSale && (
                                    <span className="text-xs bg-gradient-to-r from-primary to-blue-600 text-white px-2 py-0.5 rounded-full font-medium flex items-center gap-1">
                        ...
                        <div className="border-t-2 border-gray-200 pt-5">
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between items-center py-1">
                                    ...
                                    <span className="font-semibold text-gray-900">
                                        {!isAuthenticated && hidePricesForGuests ? (
                                            <Link href="/auth?redirect=cart" className="text-primary hover:underline"> Login to view</Link>
                                ...
                                {totals.shipping > 0 && cart.freeShippingThreshold > 0 && (
                                    <div className="mt-2 text-sm text-primary bg-blue-50 p-3 rounded-lg text-center font-medium border border-blue-200 flex items-center justify-center gap-2">
