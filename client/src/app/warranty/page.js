...
export const metadata = {
    title: "Warranty Policy | Genuine Grocery",
                ...
                <div className="section-container max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <ol className="space-y-3 mb-8 list-decimal list-inside">
                            <li><strong>Contact Support:</strong> Email us at connect.genuinenutrition@gmail.com </li>
                        ...
                        <ul className="space-y-2">
                            <li>Email: <strong>connect.genuinenutrition@gmail.com</strong></li>
