        ...
        try {
            ...
            if (paymentMethod === "CASH") {
                ...
                const options = {
                    ...
                    name: "Genuine Grocery",
                    description:
                        "Pure & Fresh Grocery Products - All your daily essentials.",
                    ...
                    theme: {
                        color: "#1861A0", // Use primary color for Razorpay modal
                    },
                    modal: {
                        ondismiss: function () {
                    ...
                    <div className="relative z-10">
                        <div className="relative flex justify-center">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="animate-ping absolute h-32 w-32 rounded-full bg-blue-500 opacity-10 delay-150"></div>
                                <div className="animate-ping absolute h-24 w-24 rounded-full bg-blue-400 opacity-10 delay-300"></div>
                            </div>
                        </div>
                        ...
                        <div className="divide-y">
                            ...
                            <div className="py-4 space-y-2 text-sm">
                                ...
                                {totals.shipping > 0 && cart.freeShippingThreshold > 0 && (
                                    <div className="mt-3 text-xs text-primary bg-blue-50 p-2 rounded text-center font-medium border border-blue-200">
