  ...
  return (
    <div
      className={cn(
        ...
        isList ? "flex-row w-full min-h-[160px] md:min-h-[220px]" : "flex-col h-full hover:-translate-y-2"
      )}
    ...
    >
      ...
      <Link
        ...
        className={cn(
          ...
          isList ? "w-32 sm:w-48 md:w-64" : "w-full"
        )}
      ...
      >
        ...
        <Image
          ...
          fill
          className={cn(
            "object-contain p-2 md:p-4 transition-transform duration-700",
      ...
      {/* ── Info Area ── */}
      <div className={cn(
        "flex flex-col flex-grow p-2 md:p-4",
        ...
        <Link href={`/products/${product.slug}`} className="block mb-1">
            <h3 className={cn(
                ...
                isList ? "text-xl md:text-2xl" : "text-base line-clamp-2"
            )}>
                {product.name}
            </h3>
        ...
        {/* Pricing & Actions */}
        <div className={cn(
            "mt-auto flex items-end justify-between gap-4 pt-1 border-t border-gray-50",
            isList ? "max-w-md" : ""
        )}>
